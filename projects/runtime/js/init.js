var init = function (window) {
    ...
    var hud = opspark.makeHud(); //created a variable called hud that holds the data for the hud.
    view.addChild(hud); //adds the HUD to the canvas and makes it viewable.
